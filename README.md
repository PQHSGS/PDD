...
- **P6 Cluster Auto-Labeling**: now a built-in pipeline stage (`auto_label` config block in the JSON config).
  ...
  ([`pdd/autolabel.py`](file:///mnt/disk4/pquan/PDD/pdd/autolabel.py)).
...
- [x] P6 Cluster auto-labeling stage (B_k LLM labels, T_m whole-cluster labels, A_k/R_m example indices) ([`pdd/autolabel.py`](file:///mnt/disk4/pquan/PDD/pdd/autolabel.py))